...
PlistTrailer = namedtuple(
    "PlistTrailer", "offsetSize, objectRefSize, offsetCount, topLevelObjectNumber, offsetTableOffset"
)
            ...
            while offset_i < self.trailer.offsetCount:
                ...
                if end > offset_table_length:
                    raise InvalidPlistException(
                        "End of object is at invalid offset %d in offset table of length %d"
