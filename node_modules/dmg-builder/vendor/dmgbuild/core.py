...
def build_dmg():
    ...
    views = {"icon-view": b"icnv", "column-view": b"clmv", "list-view": b"Nlsv", "coverflow": b"Flwv"}

    icvl = (b"type", views.get(default_view, "icnv"))

    include_icon_view_settings = default_view == "icon-view" or options["include_icon_view_settings"] not in (
        "auto",
        "no",
        0,
        False,
