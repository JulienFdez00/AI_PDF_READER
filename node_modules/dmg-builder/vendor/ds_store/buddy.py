...
class Allocator(object):
    ...
    def open(cls, file_or_name, mode="r+"):
        ...
        if "w" in mode:
            ...
            root = b"".join(
                [struct.pack(b">III", 1, 0, 2048 | 5), struct.pack(b">I", 0) * 255, struct.pack(b">I", 0)] + free_list
            )
            f.write(root)
    ...
    def flush(self):
        if self._dirty:
            ...
            self._file.write(struct.pack(b">I4sIII16s", 1, b"Bud1", offset, size, offset, self._unknown1))
